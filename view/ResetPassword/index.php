...
<head lang="en">
	...
	<title>ATNPortal - Recuperar Contraseña</title>
        ...
        <div class="page-center-in">
            <div class="container-fluid">
                <form class="sign-box reset-password-box">
                    ...
                    <button type="button" id="btnenviar" class="btn btn-rounded btn-danger">Enviar</button> o <a href="../../index.php">Regresar</a>
                </form>
            </div>
        </div>
    </div><!--.page-center-->
