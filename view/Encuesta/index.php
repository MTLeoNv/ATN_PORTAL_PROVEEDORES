...
<html>
<head>
	<title>Encuesta ATNPortal</title>
                ...
                <section class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nombreCompleto">Nro de Factura</label>
                            <input type="text" class="form-control" id="lblnomidfactura" name="lblnomidfactura" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
        ...
        <div id="panel1">
            ...
            <section class="row">
                <div class="col-md-12 text-center">
                    <input id="fact_estre" name="fact_estre" class="rating rating-loading" data-min="0" data-max="5" data-step="1" value="0">
                </div>
            </section>
            ...
            <section class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="fact_coment" name="fact_coment" class="form-control" rows="6" id="comentarios"></textarea>
                    </div>
                </div>
            </section>
