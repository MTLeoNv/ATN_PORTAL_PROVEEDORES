						...
						<div class="col-sm-4">
	                        <article class="statistic-box green">
	                            <div>
	                                ...
	                                <div class="caption"><div>Total de Facturas</div></div>
	                            </div>
	                        </article>
	                    </div>
						<div class="col-sm-4">
	                        <article class="statistic-box yellow">
	                            <div>
	                                ...
	                                <div class="caption"><div>Total de Facturas Abiertas</div></div>
	                            </div>
	                        </article>
	                    </div>
						<div class="col-sm-4">
	                        <article class="statistic-box red">
	                            <div>
	                                ...
	                                <div class="caption"><div>Total de Facturas Cerradas</div></div>
	                            </div>
	                        </article>
	                    </div>
					</div>
