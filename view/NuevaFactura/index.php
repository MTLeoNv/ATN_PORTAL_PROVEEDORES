...
<body class="with-side-menu">
	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				<p>
					Desde esta ventana podra generar nuevos facturas de ATNPortal.
				</p>
					...
					<form method="post" id="factura_form">
						...
						<div class="col-lg-12">
							<fieldset class="form-group">
								...
								<input type="text" class="form-control" id="fact_titulo" name="fact_titulo" placeholder="Ingrese Titulo">
							</fieldset>
						</div>
						...
						<div class="col-lg-12">
							<fieldset class="form-group">
								<label class="form-label semibold" for="fact_descrip">Descripción</label>
								<div class="summernote-theme-1">
									<textarea id="fact_descrip" name="fact_descrip" class="summernote" name="name"></textarea>
								</div>
							</fieldset>
						</div>
						<div class="col-lg-12">
	...
	<script type="text/javascript" src="nuevafactura.js"></script>
